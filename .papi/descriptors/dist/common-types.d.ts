...
export type Ie2utffa038qbn = {
    ...
    "input": Anonymize<I4s1615p79mda9>;
...
export type I6n992ikreen29 = (Array<{
...
export type Ialrv23ea1slun = Array<{
    "phase": Phase;
    "event": Anonymize<I74vnfdjtue8j0>;
    "topics": Anonymize<Ic5m5lp1oioo8r>;
}>;
export type I74vnfdjtue8j0 = AnonymousEnum<{
    "System": Anonymize<Iedgn3q9dokrfq>;
    "ParachainSystem": Anonymize<Icbsekf57miplo>;
    "MultiBlockMigrations": Anonymize<I94co7vj7h6bo>;
    "Balances": Anonymize<I413ocpjqkc7sv>;
    "TransactionPayment": TransactionPaymentEvent;
    ...
    "Utility": Anonymize<Ib7ia5flaghfc7>;
    "Multisig": Anonymize<I66mkdpleq1jhs>;
    "Proxy": Anonymize<I4jhhfnljoa222>;
    "Assets": Anonymize<I6avancvg8fd05>;
    ...
    "Sudo": Anonymize<I1qsqlcdtsoi8n>;
}>;
export type Iedgn3q9dokrfq = AnonymousEnum<{
    /**
     * An extrinsic completed successfully.
     */
    "ExtrinsicSuccess": Anonymize<Ia82mnkmeo2rhc>;
     ...
     * An extrinsic failed.
     */
    "ExtrinsicFailed": Anonymize<I66k6fvnspd200>;
    /**
     * `:code` was updated.
     */
    "CodeUpdated": undefined;
     ...
     * An invalid authorized upgrade was rejected while trying to apply it.
     */
    "RejectedInvalidAuthorizedUpgrade": Anonymize<I1jd2hf1bqb9pv>;
}>;
export type I66k6fvnspd200 = {
    "dispatch_error": Anonymize<I4giukovgugsa2>;
    "dispatch_info": Anonymize<Ic9s8f85vjtncc>;
};
export type I4giukovgugsa2 = AnonymousEnum<{
    "Other": undefined;
    "CannotLookup": undefined;
    "BadOrigin": undefined;
    "Module": Enum<{
...
export type I1jd2hf1bqb9pv = {
    "code_hash": FixedSizeBinary<32>;
    "error": Anonymize<I4giukovgugsa2>;
};
export type I413ocpjqkc7sv = AnonymousEnum<{
    /**
     * An account was created with some free balance.
     */
    "Endowed": Anonymize<Icv68aq8841478>;
     ...
     */
    "Held": Anonymize<Ief9bhnc52ufeh>;
    /**
     * Held balance was burned from an account.
     */
    "BurnedHeld": Anonymize<Ief9bhnc52ufeh>;
    /**
     * A transfer of `amount` on hold from `source` to `dest` was initiated.
     */
    "TransferOnHold": Anonymize<I38lgogele7bda>;
    /**
     * The `transferred` balance is placed on hold at the `dest` account.
     */
    "TransferAndHold": Anonymize<I2cujcn45bg176>;
    /**
     * Some balance was released from hold.
     */
    "Released": Anonymize<Ief9bhnc52ufeh>;
    /**
     * An unexpected/defensive event was triggered.
     */
    "Unexpected": Anonymize<Iph9c4rn81ub2>;
}>;
export type Ief9bhnc52ufeh = {
    "reason": Anonymize<Ibqgnhk1i9m9kt>;
    "who": SS58String;
    "amount": bigint;
};
export type Ibqgnhk1i9m9kt = AnonymousEnum<{
    "Session": Enum<{
        "Keys": undefined;
    }>;
    "PolkadotXcm": Anonymize<Ideiof6273rsoe>;
...
export type I38lgogele7bda = {
    "reason": Anonymize<Ibqgnhk1i9m9kt>;
    "source": SS58String;
    "dest": SS58String;
    "amount": bigint;
};
export type I2cujcn45bg176 = {
    "reason": Anonymize<Ibqgnhk1i9m9kt>;
    "source": SS58String;
    "dest": SS58String;
    "transferred": bigint;
...
export type Ib7ia5flaghfc7 = AnonymousEnum<{
    /**
     * Batch of dispatches did not complete fully. Index of first failing dispatch given, as
     * well as the error.
     */
    "BatchInterrupted": Anonymize<Iasu2kgbqblpv8>;
    /**
     * Batch of dispatches completed fully with no error.
     */
    "BatchCompleted": undefined;
     ...
     * A single item within a Batch of dispatches has completed with error.
     */
    "ItemFailed": Anonymize<Icdkrfv6qu83oa>;
    /**
     * A call was dispatched.
     */
    "DispatchedAs": Anonymize<I4q0v9le4fg9te>;
    /**
     * Main call was dispatched.
     */
    "IfElseMainSuccess": undefined;
     ...
     * The fallback call was dispatched.
     */
    "IfElseFallbackCalled": Anonymize<I826h53ehh2ftt>;
}>;
export type Iasu2kgbqblpv8 = {
    "index": number;
    "error": Anonymize<I4giukovgugsa2>;
};
export type Icdkrfv6qu83oa = {
    "error": Anonymize<I4giukovgugsa2>;
};
export type I4q0v9le4fg9te = {
    "result": Anonymize<Ifhk0is8m7bqaq>;
};
export type Ifhk0is8m7bqaq = ResultPayload<undefined, Anonymize<I4giukovgugsa2>>;
export type I826h53ehh2ftt = {
    "main_error": Anonymize<I4giukovgugsa2>;
};
export type I66mkdpleq1jhs = AnonymousEnum<{
    /**
     * A new multisig operation has begun.
     */
    "NewMultisig": Anonymize<Iep27ialq4a7o7>;
     ...
     * A multisig operation has been executed.
     */
    "MultisigExecuted": Anonymize<I4j2vhe3ignnek>;
    /**
     * A multisig operation has been cancelled.
     */
    "MultisigCancelled": Anonymize<I5qolde99acmd1>;
...
export type I4jhhfnljoa222 = AnonymousEnum<{
    /**
     * A proxy was executed correctly, with the given.
     */
    "ProxyExecuted": Anonymize<I4q0v9le4fg9te>;
    /**
     * A pure account has been created by new proxy with given
     * disambiguation index and proxy type.
     */
...
export type I1qsqlcdtsoi8n = AnonymousEnum<{
    /**
     * A sudo call just took place.
     */
    "Sudid": Anonymize<I51opnh747bkbp>;
    /**
     * The sudo key has been updated.
     */
    "KeyChanged": Anonymize<I5rtkmhm2dng4u>;
     ...
     * A [sudo_as](Pallet::sudo_as) call just took place.
     */
    "SudoAsDone": Anonymize<I51opnh747bkbp>;
}>;
export type I51opnh747bkbp = {
    /**
     * The result of the call made by the sudo user.
     */
    "sudo_result": Anonymize<Ifhk0is8m7bqaq>;
};
...
export type I14i9pui8lc778 = {
    "account_type": Enum<{
        "Contract": Anonymize<I5t5eoogd7ekut>;
        "EOA": undefined;
    }>;
    "dust": number;
};
...
export type I2haiol37irl7h = AnonymousEnum<{
    /**
     * Send a batch of dispatch calls.
     *
     * May be called from any origin except `None`.
     ...
     * event is deposited.
     */
    "batch": Anonymize<I6mcnkbev8r279>;
    /**
     * Send a call through an indexed pseudonym of the sender.
     *
     * Filter from origin are passed along. The call will be dispatched with an origin which
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "as_derivative": Anonymize<I7brff5qvjjmff>;
    /**
     * Send a batch of dispatch calls and atomically execute them.
     * The whole transaction will rollback and fail if any of the calls failed.
     *
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    "batch_all": Anonymize<I6mcnkbev8r279>;
    /**
     * Dispatches a function call with a provided origin.
     *
     * The dispatch origin for this call must be _Root_.
     ...
     * - O(1).
     */
    "dispatch_as": Anonymize<I6dhavfjnaqr6f>;
    /**
     * Send a batch of dispatch calls.
     * Unlike `batch`, it allows errors and won't interrupt.
     *
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    "force_batch": Anonymize<I6mcnkbev8r279>;
    /**
     * Dispatch a function call with a specified weight.
     *
     * This function does not check the weight of the call, and instead allows the
     ...
     * The dispatch origin for this call must be _Root_.
     */
    "with_weight": Anonymize<Idg8q6inn8r0h3>;
    /**
     * Dispatch a fallback call in the event the main call fails to execute.
     * May be called from any origin except `None`.
     *
     ...
     * or both.
     */
    "if_else": Anonymize<Ifq7vqmqjjeui9>;
    /**
     * Dispatches a function call with a provided origin.
     *
     * Almost the same as [`Pallet::dispatch_as`] but forwards any error of the inner call.
     ...
     * The dispatch origin for this call must be _Root_.
     */
    "dispatch_as_fallible": Anonymize<I6dhavfjnaqr6f>;
}>;
export type I6mcnkbev8r279 = {
    "calls": Array<TxCallData>;
};
export type I7brff5qvjjmff = {
    "index": number;
    "call": TxCallData;
};
export type I6dhavfjnaqr6f = {
...
export type Idg8q6inn8r0h3 = {
    "call": TxCallData;
    "weight": Anonymize<I4q39t5hn830vp>;
};
export type Ifq7vqmqjjeui9 = {
    "main": TxCallData;
    "fallback": TxCallData;
};
export type I6e8pnphfrlpt4 = AnonymousEnum<{
    /**
     * Immediately dispatch a multi-signature call using a single approval from the caller.
     *
     * The dispatch origin for this call must be _Signed_.
     ...
     * O(Z + C) where Z is the length of the call and C its execution weight.
     */
    "as_multi_threshold_1": Anonymize<I8u8gaua5dlos5>;
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
     * approved by a total of `threshold - 1` of `other_signatories`.
     *
     ...
     * taken for its lifetime of `DepositBase + threshold * DepositFactor`.
     */
    "as_multi": Anonymize<Iao4msbsec3auj>;
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
     * approved by a total of `threshold - 1` of `other_signatories`.
     *
...
export type I8u8gaua5dlos5 = {
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "call": TxCallData;
};
export type Iao4msbsec3auj = {
    "threshold": number;
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "maybe_timepoint"?: Anonymize<I95jfd8j5cr5eh>;
    "call": TxCallData;
...
export type I1h8tnemjad9c3 = AnonymousEnum<{
    /**
     * Dispatch the given `call` from an account that the sender is authorised for through
     * `add_proxy`.
     *
     ...
     * - `call`: The call to be made by the `real` account.
     */
    "proxy": Anonymize<If4nu34lsg7f1v>;
    /**
     * Register a proxy account for the sender that is able to make calls on its behalf.
     *
     * The dispatch origin for this call must be _Signed_.
     ...
     * - `call`: The call to be made by the `real` account.
     */
    "proxy_announced": Anonymize<I65vn63iec1lmp>;
    /**
     * Poke / Adjust deposits made for proxies and announcements based on current values.
     * This can be used by accounts to possibly lower their locked amount.
     *
...
export type If4nu34lsg7f1v = {
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<I7rk1n3vg3et43>;
    "call": TxCallData;
};
export type I65vn63iec1lmp = {
    "delegate": MultiAddress;
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<I7rk1n3vg3et43>;
    "call": TxCallData;
...
export type I1qakb3bdfcq49 = AnonymousEnum<{
    /**
     * A raw EVM transaction, typically dispatched by an Ethereum JSON-RPC server.
     *
     * # Parameters
     ...
     * recovery function in case an `AccountId20` was used without creating a mapping first.
     */
    "dispatch_as_fallback_account": Anonymize<I8qegh6i6n5iim>;
}>;
...
export type Ih9pnb93qv5kg = AnonymousEnum<{
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     */
    "sudo": Anonymize<I8qegh6i6n5iim>;
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     * This function does not check the weight of the call, and instead allows the
     * Sudo user to specify the weight of the call.
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "sudo_unchecked_weight": Anonymize<Idg8q6inn8r0h3>;
    /**
     * Authenticates the current sudo key and sets the given AccountId (`new`) as the new sudo
     * key.
     */
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "sudo_as": Anonymize<Ifs6mu8539se3v>;
    /**
     * Permanently removes the sudo key.
     *
     * **This cannot be un-done.**
...
export type Ifs6mu8539se3v = {
    "who": MultiAddress;
    "call": TxCallData;
};
export type Icnrqcl9elbmr7 = AnonymousEnum<{
    "System": Anonymize<Iekve0i6djpd9f>;
    ...
    "Utility": Anonymize<I2haiol37irl7h>;
    "Multisig": Anonymize<I6e8pnphfrlpt4>;
    "Proxy": Anonymize<I1h8tnemjad9c3>;
    "Assets": Anonymize<I84851acvod2ic>;
    ...
    "Revive": Anonymize<I1qakb3bdfcq49>;
    ...
    "Sudo": Anonymize<Ih9pnb93qv5kg>;
}>;
export type Ibbif23655j96e = ResultPayload<Anonymize<Ifhk0is8m7bqaq>, Anonymize<I5nrjkj9qumobs>>;
...
export type Ifnlq2bqp2aio0 = Array<Anonymize<I74vnfdjtue8j0>>;
...
export type I9kuqodam0fk32 = ResultPayload<{
...
export type I5juq6bf28aoa3 = {
    "gas_consumed": Anonymize<I4q39t5hn830vp>;
    "gas_required": Anonymize<I4q39t5hn830vp>;
    "storage_deposit": Anonymize<If7bmpttbdmqu4>;
    "result": ResultPayload<Anonymize<I620n7irgfspm4>, Anonymize<I4giukovgugsa2>>;
};
export type I4ipvv4sgn3ndo = {
    "gas_consumed": Anonymize<I4q39t5hn830vp>;
    "gas_required": Anonymize<I4q39t5hn830vp>;
    "storage_deposit": Anonymize<If7bmpttbdmqu4>;
    "result": ResultPayload<Anonymize<I6cm3omaniofs7>, Anonymize<I4giukovgugsa2>>;
};
export type Id04d8vi9vg8i = {
    "access_list"?: Anonymize<I6n992ikreen29>;
...
export type Ie2avqtk8g5n7r = ResultPayload<Anonymize<Icjs1v5avc8kdj>, Anonymize<I4giukovgugsa2>>;
