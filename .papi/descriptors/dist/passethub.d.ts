...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I585gsq0ooc33i>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ic6q0j6kvnbbd1>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Idi88mtp2dmvbp>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ic6q0j6kvnbbd1>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I5pv97l2cn3b5b>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ic6q0j6kvnbbd1>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I7h0gh6okupu5b>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<I72sj7ancs3pom>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I5pv97l2cn3b5b>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ibrkh2rfnj8u5p>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Id5fubkmdnhelq>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<Id5hqmljvbn3ca>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I1ids7og132p47>>;
        /**
    ...
    Revive: {
         ...
         */
        eth_instantiate_with_code: TxDescriptor<Anonymize<Iboosov053lfpm>>;
        /**
         ...
         */
        dispatch_as_fallback_account: TxDescriptor<Anonymize<I4b2bq1ngibpmn>>;
    };
    AssetRewards: {
        /**
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I4b2bq1ngibpmn>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<I7h0gh6okupu5b>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<Icnrd7tduou6dh>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I8nbjodpq1kgqq>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<I8u33s8km6nmts>>;
    };
    ParachainSystem: {
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I5mejgkavvdu1j>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ie5nr4mg3bjr97>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<Iatrq272fmngd>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<Iertboe4ltfn0b>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I9840bgc20hmje>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<Iatrq272fmngd>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I4fmdrk5deg44j>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I4fmdrk5deg44j>>;
    };
};
type IError = {
    System: {
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<I459f5v67puco7>, proxy_type: Anonymize<I5ftepkjop3g1u>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I8i0gq457iq4s6>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I9g869l9vmunib>, call: Anonymize<I459f5v67puco7>, result_xcms_version: number], Anonymize<I1a8k3v4fomnmp>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: Anonymize<Ip0q3s6hi9qht>], Anonymize<Ieuv3n4r8cnbh8>>;
    };
    /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I459f5v67puco7>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I459f5v67puco7>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    ReviveApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: FixedSizeBinary<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Binary], Anonymize<Iaeggm282l1hn0>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Binary, salt: Anonymize<I4s6vifaf8k998>], Anonymize<I45tbes153d19q>>;
        /**
         ...
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Binary, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<I55iette934g18>>;
        /**
         ...
         */
        trace_call: RuntimeDescriptor<[tx: Anonymize<Ie2utffa038qbn>, config: Anonymize<I63nhnkgg114n5>], Anonymize<Icifup6o102f4c>>;
        /**
...
export type PassethubDispatchError = Anonymize<Iejeuenmp2ctmf>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PassethubCallData = Anonymize<I459f5v67puco7> & {
    value: {
        type: string;
    };
};
